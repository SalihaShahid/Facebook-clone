...
path("view_text_story_comments<int:id>",view_text_story_comments,name="view_text_story_comments"),
path("view_text_story_likes<int:id>",view_text_story_likes,name="view_text_story_likes"),
path("view_media_story_comments<int:id>",view_media_story_comments,name="view_media_story_comments"),
path("view_media_story_likes<int:id>",view_media_story_likes,name="view_media_story_likes"),
path("text_story_comment<int:id>",text_story_comment,name="text_story_comment"),
path("media_story_comment<int:id>",media_story_comment,name="media_story_comment"),
path("text_story_like<int:id>",text_story_like,name="text_story_like"),
path("media_story_like<int:id>",media_story_like,name="media_story_like"),
